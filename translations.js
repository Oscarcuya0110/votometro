...
const T = {
  es: {
    ...
    heroSub:        "Responde 22 preguntas sobre los temas que más importan y encuentra tu candidato ideal entre los 36 participantes.",
    ...
    resultsSub:     "Basado en tus respuestas a las 22 preguntas",
  ...
  qu: {
    ...
    heroSub:        "Iskay chunka iskayyuq tapuykusman kutichiy, 36 akllakuqkunawan tupachiy.",
    startBtn:       "Qallariy →",
    ...
    resultsSub:     "Iskay chunka iskayyuq kutichisqaykiwan",
  ...
  ay: {
    ...
    resultsSub:     "Tunka paqallqunini iskayanini tapuqanaka",
